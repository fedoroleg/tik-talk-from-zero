import { accountsActions } from './lib/data-access/account.actions';

export { AccountsService } from './lib/data-access/account.service';
export { AccountPageComponent } from './lib/feature-account-page/account-page.component';
...
export * from './lib/data-access/account.actions';
